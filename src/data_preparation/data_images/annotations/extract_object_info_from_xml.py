...
def label_encoding(label):
    ...
    """
    labels = {
        'person': 0, 'bicycle': 1, 'car': 2, 'bus': 3, 'train': 4, 'traffic_sign': 5, 'traffic_light': 6,
        'rail': 7, 'pothole': 8, 'pole': 9, 'downstair':10, 'upstair': 11, 'curb': 12, 'truck':13,
        'green_pedestrian_light': 14, 'red_pedestrian_light': 15, 'garbage container': 16
    }
    try:
        return labels[label]
    except KeyError:
